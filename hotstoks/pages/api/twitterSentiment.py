...
def sentiment():
    ...
    if query != '':
        ...
        if noOfTweet != '' :
            ...
            if noOfDays != '':
                    ...
                    tweets_list = []
                    now = dt.date.today()-dt.timedelta(days = ((365*num)+215))
                    now = now.strftime('%Y-%m-%d')
                    yesterday = (dt.date.today()-dt.timedelta(days = ((365*num)+215))) - dt.timedelta(days = int(noOfDays))
    ...
    #Making composite score
    composite = (positive - negative) / 100
    ...
    #print(end='\n')
    #print("Composite Score(%):",    '%.2f' % composite, end='\n')
